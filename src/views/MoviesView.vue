...
const { items, loading, error, load } = useMediaLibrary('Movie')
    ...
    <main class="pt-16">
      ...
      <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div class="relative w-full sm:w-72">
            ...
            <input
              ...
              class="w-full bg-jellyfin-surface border border-jellyfin-border text-jellyfin-text placeholder-jellyfin-muted/60 rounded-lg pl-10 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-jellyfin-primary focus:border-transparent outline-none transition"
            />
          </div>
        </div>
        ...
        >
          ...
          <p class="text-jellyfin-muted">No movies found for "<strong class="text-jellyfin-text">{{ search }}</strong>"</p>
